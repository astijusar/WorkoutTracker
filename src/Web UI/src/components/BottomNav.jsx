...
const BottomNav = () => {
    ...
    return (
        <div className="btm-nav w-full shadow-[black_0px_-5px_5px_-5px] sm:mx-auto sm:w-2/3 md:w-3/5 lg:w-3/6 xl:w-1/3">
            <button className={`${location.pathname.slice(1) === "profile" ? "active" : ""} bg-neutral sm:rounded-bl-2xl`}
            ...
            <button className={`${location.pathname.slice(1) === "history" ? "active" : ""} bg-neutral`}
            ...
            <button className={`${location.pathname.slice(1) === "start-workout" ? "active" : ""} bg-neutral`}
            ...
            <button className={`${location.pathname.slice(1) === "exercises" ? "active" : ""} bg-neutral sm:rounded-br-2xl`}
                onClick={() => navigate("/exercises")}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6"><path d="M3.375 3C2.339 3 1.5 3.84 1.5 4.875v.75c0 1.036.84 1.875 1.875 1.875h17.25c1.035 0 1.875-.84 1.875-1.875v-.75C22.5 3.839 21.66 3 20.625 3H3.375z" /><path fillRule="evenodd" d="M3.087 9l.54 9.176A3 3 0 006.62 21h10.757a3 3 0 002.995-2.824L20.913 9H3.087zm6.163 3.75A.75.75 0 0110 12h4a.75.75 0 010 1.5h-4a.75.75 0 01-.75-.75z" clipRule="evenodd" /></svg>
                <span className="btm-nav-label">Exercises</span>
            </button>
        </div>
    )
}
