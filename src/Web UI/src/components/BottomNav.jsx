...
const BottomNav = () => {
    ...
    return (
        <div className="btm-nav w-full shadow-[black_0px_-5px_5px_-5px] sm:mx-auto sm:w-2/3 md:w-3/5 lg:w-3/6 xl:w-1/3">
            <button className={`${activeTab === "profile" ? "active" : ""} bg-neutral sm:rounded-bl-2xl`}
            ...
            <button className={`${activeTab === "history" ? "active" : ""} bg-neutral`}
            ...
            <button className={`${activeTab === "workout" ? "active" : ""} bg-neutral`}
            ...
            <button className={`${activeTab === "exercises" ? "active" : ""} bg-neutral sm:rounded-br-2xl`}
                onClick={() => onClick("exercises")}>
